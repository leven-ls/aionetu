...
const OldPhotoPage = () => {
  ...
  const queuePrompt = async () => {
    ...
    formData.append('workflow', 'oldphoto_repair');
  ...
  return (
    <div className="h-full w-full flex flex-col">
      <div className="px-4 lg:px-8 flex items-center gap-x-3 mb-8">
        ...
        <div>
          <h2 className="text-3xl font-bold">老照片修复</h2>
      ...
      <div className="px-4 lg:px-8 flex flex-col h-full">
        <div className="flex h-full pb-6 pl-1 pr-6 space-x-2">
          <div className="w-full sm:w-1/2 relative border">
          ...
          <div className="w-full sm:w-1/2 relative border flex items-center justify-center">
            {isFetching ?
              ...
              :
              <>
                <Image src={restroredPhoto || '/old_photo_example.png'} alt="" className="p-2" layout="fill" objectFit="contain" sizes="100vw"></Image>
                {restroredPhoto &&
                  <button
