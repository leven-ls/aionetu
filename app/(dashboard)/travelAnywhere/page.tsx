...
const TravelAnywherePage = () => {
  ...
  const [place, setPlace] = useState('Sydney Opera House');
  ...
  const queuePrompt = async () => {
    ...
    formData.append('workflow', 'travelAnywhere');
  ...
  return (
    <div className="h-full w-full flex flex-col">
      <div className="px-4 lg:px-8 flex items-center gap-x-3 mb-8">
        ...
        <div>
          <h2 className="text-3xl font-bold">旅游照</h2>
        ...
        <Select value={place} onValueChange={(v) => { setPlace(v) }}>
          ...
          <SelectContent>
            <SelectGroup>
              <SelectItem value="Sydney Opera House">悉尼歌剧院</SelectItem>
              <SelectItem value="eiffel tower">埃菲尔铁塔</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
        ...
        <div className="flex h-full pb-6 pl-1 pr-6 space-x-2">
          ...
          <div className="md:w-1/2 relative border flex items-center justify-center">
            {isFetching ?
              ...
              :
              <>
                <Image src={restroredPhoto || '/travel_example.png'} alt="" className="p-2" layout="fill" objectFit="contain" sizes="100vw"></Image>
                {restroredPhoto &&
                  <button
...
export default TravelAnywherePage;
